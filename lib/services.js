...
const RAW = [
  ...
  {
    // ── THE NICHE BET ────────────────────────────────────────
    // Deliberately narrower than every other service here, and that is
    // the point. "GoHighLevel funnels" is contested by hundreds of
    // agencies; "GoHighLevel for care agencies" is contested by almost
    // nobody, while the buyers have recurring revenue and a genuine,
    // expensive problem. Narrow and winnable beats broad and invisible.
    slug: 'ghl-funnels-for-care-agencies',
    icon: 'funnel',
    color: 'mint',
    title: 'GoHighLevel for Care Agencies',
    short: 'Enquiry follow-up, family nurture and carer recruitment automated in GoHighLevel — built for home care and care agencies.',
    seoTitle: 'GoHighLevel for Care Agencies | Care Enquiry Automation — Flowzync',
    seoDescription:
      'GoHighLevel setup built for home care and care agencies: instant enquiry response, family follow-up sequences, carer recruitment pipelines and CQC-aware forms.',
    keywords: [
      'gohighlevel for care agencies', 'care agency crm', 'home care lead follow up',
      'care agency automation', 'domiciliary care crm', 'carer recruitment automation',
      'care enquiry management software', 'gohighlevel home care', 'care agency marketing automation',
    ],
    hero:
      'Care enquiries arrive at nine in the evening from a worried family contacting three providers at once. Whoever answers first usually gets the visit. This is a GoHighLevel setup built around that one fact — plus the recruitment pipeline that is quietly half of why the website exists.',
    features: [
      ['Instant enquiry acknowledgement', 'A family enquiry triggers an SMS and email within seconds, setting out what happens next and when. It is the single highest-return automation in this sector, because families are contacting several providers the same evening.'],
      ['Family nurture that is not salesy', 'Follow-up sequences written for someone making a difficult decision about a parent — information and reassurance, paced over days, not a countdown timer.'],
      ['Carer recruitment pipeline', 'Applications flow into their own pipeline with automatic acknowledgement, document chasing for DBS and right-to-work, and interview booking. For most providers, filling shifts is half the reason the site exists.'],
      ['Assessment booking', 'Free care assessments booked into a real calendar with confirmations and reminders, so a booked visit is not lost to a forgotten diary entry.'],
      ['Enquiry data handled properly', 'Forms collect what you need to respond and nothing you have no reason to hold, with a defined retention period. Health-adjacent enquiry data deserves more care than a generic contact form gives it.'],
      ['Referral source tracking', 'Local authority, hospital discharge, word of mouth, search — tagged at the point of enquiry so you can see which sources actually convert into packages.'],
    ],
    faqs: [
      ['Why do care agencies lose enquiries?', 'Timing, almost always. Families research in the evening and at weekends, contact three or four providers in one sitting, and go with whoever responds properly first. An enquiry that sits in an inbox until Monday morning has usually already been lost — not because the care was worse, but because someone else replied on Sunday.'],
      ['Is GoHighLevel suitable for a care agency?', 'It fits well, because the problems are follow-up speed and multi-channel conversation rather than complex sales reporting. Instant SMS and email response, booking, pipelines and recruitment all sit in one subscription, and it is simple enough that a care coordinator can run it without IT support. It does not replace your rostering or care planning system — it sits in front of them, handling enquiries and applications.'],
      ['Can it help with carer recruitment?', 'That is often where the biggest return is. Applications get an immediate acknowledgement, the system chases missing DBS and right-to-work documents automatically, and interviews are booked without phone tag. Care recruitment is lost mostly to slow responses and vague adverts, and the first of those is entirely fixable.'],
      ['How does this handle sensitive enquiry information?', 'Forms are built to collect what you need to make contact and arrange an assessment, not clinical detail there is no reason to hold at enquiry stage. Data has a defined retention period and is not passed to analytics or advertising tools. We build to that standard — for a formal assessment against your own regulatory obligations, use your compliance adviser or DPO rather than a web studio.'],
      ['Will this work alongside our existing care management system?', 'Usually. Most modern care management platforms have an API or accept an export, and where a direct integration is not available we can pass enquiries through Zapier or Make. If a system genuinely has no route in, we will establish that before you commit rather than halfway through.'],
      ['How long does the setup take?', 'Typically two to four weeks for the enquiry and recruitment pipelines, sequences, calendars and forms, plus a walkthrough with the person who will actually run it day to day. That last part matters more than it sounds — a CRM nobody on the team understands is an expensive contact list.'],
    ],
  },
  {
    slug: 'automations',
