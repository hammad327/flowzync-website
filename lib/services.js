...
const RAW = [
  ...
  },
  {
    ...
    faqs: [
      ...
      ['What is a GHL snapshot and why do I need one?', 'A snapshot is a saved template of a complete account setup. If you serve one niche repeatedly, a snapshot means every new client gets a proven system in minutes instead of weeks.'],
  ...
  },
  {
    ...
    short: 'Conversion-focused Shopify stores — design, theme development, migration and CRO.',
    seoTitle: 'Shopify Store Design & Development Services — Flowzync',
    seoDescription:
      'Shopify design and development agency: custom store design, OS 2.0 theme development, platform migration, app stack strategy and conversion rate optimisation sprints.',
    keywords: ['shopify store design', 'shopify development agency', 'shopify theme development', 'shopify cro', 'shopify store design services', 'custom shopify theme development', 'shopify development agency', 'klaviyo email flows setup', 'shopify conversion optimization'],
    hero:
      'Beautiful is the baseline. We design Shopify stores around how shoppers actually decide — clear paths, honest proof, frictionless checkout.',
    features: [
      ['Store design & redesign', 'Brand-true storefronts engineered around the buying journey, from collection page to thank-you page.'],
      ['OS 2.0 theme development', 'Custom Liquid sections and blocks your team can rearrange without touching code.'],
      ['Platform migration', 'From WooCommerce, Wix, Squarespace or Magento — products, customers and SEO moved safely.'],
      ['App stack strategy', 'We cut app bloat, pick the right tools and wire reviews, upsells and loyalty together.'],
      ['CRO sprints', 'Monthly test cycles on product pages, carts and checkout that compound month after month.'],
      ['Email & retention flows', 'Klaviyo welcome, abandoned-cart and win-back flows that bring shoppers back.'],
    ],
    faqs: [
      ['Do you work with existing Shopify themes or build custom?', 'Both. We can customise a premium theme for speed-to-launch, or develop a fully custom OS 2.0 theme when your brand needs something unmistakable.'],
      ['Can you migrate my store from WooCommerce or Wix?', 'Yes — including products, variants, customers, orders and, crucially, 301 redirects so your search rankings survive the move.'],
      ['What is a CRO sprint?', 'A focused monthly cycle: analyse behaviour data, form hypotheses, run A/B tests on key pages, keep the winners. Small compounding wins add up fast.'],
      ['Do you set up email marketing too?', 'Yes, Klaviyo is part of most engagements — core flows plus campaign templates your team can reuse.'],
    ],
  },
  {
