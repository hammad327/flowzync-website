...
export const serviceDetails = {
  ...
  'ghl-crm-setup': {
    benefits: [
      ...
      ['Launch-ready in weeks', 'Skip months of trial-and-error settings. We deliver a configured, tested system with proven snapshots.'],
    ...
    approach: [
      ...
      ['Team onboarding', 'Live training plus recorded walkthroughs, so every seat is productive from week one.'],
    ],
    whyUs: [
  ...
  'graphic-design': {
    ...
    caseStudy: {
      ...
      results: [['+180%', 'Instagram engagement'], ['2 wks', 'to full brand system'], ['40+', 'ready-to-use templates']],
    },
  },
