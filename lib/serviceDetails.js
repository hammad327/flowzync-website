...
export const serviceDetails = {
  ...
  'ghl-funnels-for-care-agencies': {
    benefits: [
      ['Answer before the competition does', 'Families contact three or four providers in one evening. An automatic reply within seconds, setting out what happens next, wins a meaningful share of those on responsiveness alone.'],
      ['Fill shifts, not just packages', 'Carer applications get acknowledged, chased for documents and booked for interview automatically. For most providers recruitment is the harder half of the problem.'],
      ['Nothing sits in an inbox', 'Every enquiry creates a record, notifies the right person and chases itself if nobody has responded within an agreed window.'],
      ['See which referral sources actually convert', 'Local authority, hospital discharge, word of mouth and search tagged at enquiry, so you know where packages genuinely come from.'],
    ],
    approach: [
      ['Map the real enquiry journey', 'We start with what actually happens now — who picks up an evening enquiry, what gets asked, where it is written down and where it gets lost. Automating a broken process just breaks it faster.'],
      ['Build the two pipelines', 'Family enquiries and carer applications are different journeys with different urgency and different questions. They get separate pipelines rather than one shared inbox.'],
      ['Write the sequences for the audience', 'Follow-up for a family choosing care for a parent reads nothing like a sales sequence. Information and reassurance, paced over days.'],
      ['Hand it to the person who runs it', 'A walkthrough with your care coordinator or office manager, plus written documentation. If only we understand the system, you do not own it.'],
    ],
    whyUs: [
      ['We have built in this sector', 'Home care work including DAS Care Services, so the constraints are familiar: anxious decision-makers, inspection ratings that matter, recruitment that never stops.'],
      ['Honest about the boundary', 'We build the enquiry and recruitment layer. We do not replace your rostering, care planning or eMAR system, and we will say so rather than quoting for something we should not touch.'],
      ['Data handled with the care it deserves', 'Health-adjacent enquiry data gets defined retention, no quiet transfer to advertising tools, and forms that collect only what is needed to respond.'],
    ],
    process: [
      ['Discovery', 'One call to map how enquiries and applications reach you today, and where they currently die.'],
      ['Build', 'Pipelines, forms, sequences, calendars and notifications configured and tested with real journeys, not just saved.'],
      ['Handover', 'A walkthrough with whoever runs it daily, plus documentation you can hand to the next person.'],
      ['Support', 'A settling-in window after launch, then optional ongoing care as your services or coverage change.'],
    ],
  },
  ...
  'woocommerce-development': {
    ...
    whyUs: [
      ...
      ['Honest platform advice', 'If your margins and catalogue genuinely suit Shopify better, we will tell you so rather than sell you a WooCommerce build you do not need.'],
    ],
